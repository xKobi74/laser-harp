...
Рисунок 3. Фото используемых всех компонент за исключением источников питания, кнопок и динамиков

## 3 Проектирование корпуса

В ходе третьего этапа, зная все используемые комплектующие, мы подготовили подробную полноразмерную схема одной половины корпуса (рис. 5).

![Схема одной половины корпуса](./images/final-sketch.jpg)
Рисунок 3. Схема одной половины корпуса
