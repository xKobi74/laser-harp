...
| ------ | ------ | ------ | 
| Микроконтроллер | STM32F103C8T6 | Это бюджетный и один из самых популярных МК, его можно быстро купить. Также он обладает достаточными как вычислительной мощностью, так и набором периферии. Выбрана плата Blue Pill c алиэкспресс. |
...
| Мультиплексор | CD74HC4067 | Иммеет 16 входов (достаточно 7) и позволяет пропускать через себя аналоговый сигнал с силой тока не превышающей  |
| Динамики (2 штуки) |  |  |
| Батарейный модуль |  |  |
| Понижающий DC-DC трансворматор |  |  |
| Аккумулятор |  |  |
| Контроллер зарядки АКБ |  |  |
| Кнопка включения с фиксацией |  |  |
| Кнопки без фиксации (2 штуки) |  |  |
| Дисплей |  |  |
# Лазерная арфа
![Изготовленная лазерная арфа](./images/laser-harp.jpg)
Рисунок 1. Изготовленная лазерная арфа
